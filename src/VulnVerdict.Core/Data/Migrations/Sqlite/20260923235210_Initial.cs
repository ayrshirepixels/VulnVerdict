        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AliasNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    VendorNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ProductNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OsVendor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    OsProduct = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    OsVersion = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    OsBuild = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Criticality = table.Column<int>(type: "INTEGER", nullable: false),
                    CriticalityPinned = table.Column<bool>(type: "INTEGER", nullable: false),
                    Exposure = table.Column<int>(type: "INTEGER", nullable: false),
                    ExposureEvidence = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ExposurePinned = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    Unknown = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Signer = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    AdapterId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    DisplayName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    RunRequested = table.Column<bool>(type: "INTEGER", nullable: false),
                    Running = table.Column<bool>(type: "INTEGER", nullable: false),
                    Progress = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Kind = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assigner = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Title = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    Description = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    CvssV31Vector = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CvssV31Score = table.Column<double>(type: "REAL", nullable: true),
                    CvssV40Vector = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    CvssV40Score = table.Column<double>(type: "REAL", nullable: true),
                    SsvcExploitation = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    SsvcAutomatable = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recipients = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Percentile = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cursor = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    RunRequested = table.Column<bool>(type: "INTEGER", nullable: false),
                    Running = table.Column<bool>(type: "INTEGER", nullable: false),
                    Progress = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConnectorId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    Source = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    SourceSeverity = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Title = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    RawRef = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    FirstSeen = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastSeen = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CveId = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    VendorProject = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Product = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    VulnerabilityName = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    DateAdded = table.Column<DateTime>(type: "TEXT", nullable: false),
                    RequiredAction = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    DueDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    KnownRansomwareUse = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromptVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProductNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    WatchlistEntryId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    VerdictId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Channel = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CorrelationKey = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    ExternalRef = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    SentAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastStatus = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Exposure = table.Column<int>(type: "INTEGER", nullable: false),
                    Criticality = table.Column<int>(type: "INTEGER", nullable: false),
                    Note = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ecosystem = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Kind = table.Column<int>(type: "INTEGER", nullable: false),
                    Enabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    MappedVendorNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    MappedProductNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ProductNorm = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    DefaultStatus = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CveId = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    WatchlistEntryId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SoftwareInstanceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    AssetId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    Automatable = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    Criticality = table.Column<int>(type: "INTEGER", nullable: false),
                    Epss = table.Column<double>(type: "REAL", nullable: true),
                    InKev = table.Column<bool>(type: "INTEGER", nullable: false),
                    Tier = table.Column<int>(type: "INTEGER", nullable: false),
                    RuleNumber = table.Column<int>(type: "INTEGER", nullable: false),
                    Confidence = table.Column<int>(type: "INTEGER", nullable: false),
                    SlaDue = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Sentence = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    FixedIn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    EvidenceJson = table.Column<string>(type: "TEXT", nullable: false),
                    State = table.Column<int>(type: "INTEGER", nullable: false),
                    StateReason = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    StateOwner = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    StateChangedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SnoozedUntil = table.Column<DateTime>(type: "TEXT", nullable: true),
                    AcceptedRiskExpiry = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SuppressedByRuleId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastEvaluatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    PreviousTier = table.Column<int>(type: "INTEGER", nullable: true),
                    TierChangedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    TierChangeReason = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    ImmediateEmailSentAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    TicketSentAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    FirstDigestAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    From = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    To = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Reason = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Digested = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
