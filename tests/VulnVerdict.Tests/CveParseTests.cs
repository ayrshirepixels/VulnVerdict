...
public class CveParseTests
{
    ...
    {
        var entry = new WatchlistEntry { Vendor = "Fortinet", Product = "FortiOS", Version = "7.2.5", AssetName = "FW-EDGE-01", Exposure = Exposure.Internet, Criticality = Criticality.Critical };
